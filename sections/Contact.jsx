            ...
            <div className="grid grid-cols-2 gap-4 p-6">
                ...
                <form className="flex flex-col gap-4 "> 
                    <div className="relative ">
                        ...
                        <input type="text" placeholder="Name" className="border pl-10 p-2 rounded-md h-14 w-full"/>
                    </div>
                    <div className="relative mb-4">
                        <MdOutlineMailOutline className="absolute left-2 top-1/2 h-6 w-6 transform -translate-y-1/2 text-gray-500" />
                        <input type="email" placeholder="Email" className="border pl-10 p-2 rounded-md h-14 w-full"/>
                    </div>
                    <div className="relative mb-4">
                        <LuMessageCircleMore className="absolute left-2 top-5 h-6 w-6 transform -translate-y-1/2 text-gray-500" />
                        <textarea placeholder="Message" className="border pl-10 p-2 rounded-md h-32 w-full"></textarea>
                    </div>
                    <button type="submit" className="bg-blue-600 text-white w-1/2 p-2 rounded-md flex items-center gap-2 justify-center ">
                        Send
                        <IoMdSend />
                    </button>
                </form>
